          ...
          <form action="" method="post" class="mt4">
            @for ($i = 0; $i < count($traits); $i++)
             <div class="w-50 center <? if ($i != 0) echo 'dn dn o-0'?>" id="question-{{ $i + 1 }}">
                ...
                <div class="mv3">
                   <input type="radio" name="q{{ $i + 1 }}" value="1" class="mr2 pointer q{{ $i + 1 }}" id="q{{ $i + 1 }}_1" />
                   <label for="q{{ $i + 1 }}_1" class="pointer">Very important</label>
                </div>
                <div class="mb3">
                   <input type="radio" name="q{{ $i + 1 }}" value="2" class="mr2 pointer q{{ $i + 1 }}" id="q{{ $i + 1 }}_2"/>
                ...
                <div class="mb3">
                   <input type="radio" name="q{{ $i + 1 }}" value="4" class="mr2 pointer q{{ $i + 1 }}" id="q{{ $i + 1 }}_4"/>
                   <label for="q{{ $i + 1 }}_4" class="pointer">Slightly Important</label>
                </div>
                <div class="mb3">
                   <input type="radio" name="q{{ $i + 1 }}" value="5" class="mr2 pointer q{{ $i + 1 }}" id="q{{ $i + 1 }}_5"/>
