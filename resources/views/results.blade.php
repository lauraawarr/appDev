      ...
      <!-- Used Nicole's navigation and styling -->
          ...
          <h2 class="tc dark-gray f2 mt0">Results</h2>
            ...
            <div class="other-products dt-ns dt--fixed-ns mt0">
              <div class="dib-m dtc-ns tc pv4">
                ...
                <p class="dn dn-0">{{$result[1] -> description}}</p>
                <!-- <p>{{ $result[1] -> img}}</p> -->
        ...
        <div class="tl mt4">
          <span>
            ...
            <a href="../start-quiz.html" class="blue no-underline ml3 mr3 f4 b"><img src="../fonts/retake.svg" class="w1 pr1 mb0">Retake Quiz</a>
            <a href="../comparison.html" class="blue no-underline mr3 f4 b">Compare Results</a>
          </span>
        </div>
        <!--  script files -->
